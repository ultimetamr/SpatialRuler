...
> Role: `research_analyst` | Active revision: 4 | Workflow stage: `research` + bounded change requests CR-01/CR-03/CR-04
> Upstream: `pm-requirement-spec.md` r1, 用户原始材料, `knowledge/official-rules.json` v2.2.0 | Observation date: 2026-08-15
...
|---|---|---|---|---|---|---|---|---|
| E-M1 | market | 移动 AR 测量的基线能力已包括两点长度、矩形/面积、高度和截图；因此仅“能量”不足以形成差异 | Apple Measure 官方指南；AR Ruler App 官方商店页 | official | iOS/Android 同任务邻近产品 | high | accessed 2026-08-15 | 将基线功能与 PICO 原型任务成功率对比，不复用其 UI |
...
| C2 | AR Ruler App / iOS & Android | 长度、距离、角度、面积/周长、多点路径、高度、体积、房间扫描、多单位，功能覆盖广 | 观察：相机对准平面后切工具并点按放点，某些能力受订阅/硬件影响。**低信心推断**：多工具可能增加选择成本，待上手计时测试 | 观察：工具集式信息架构。**低信心推断**：工具盘可能侵占现场视线，待屏占比/任务观察 | 利用平面、尺度、距离，但仍受手持相机/屏幕限制；应迁移“工具覆盖”而非 UI | App Store/Google Play official listing, accessed 2026-08-15: https://apps.apple.com/us/app/ar-ruler-digital-tape-measure/id1326773975 |
...
| C2 | 四种核心模式覆盖、多单位、路径总长、高度/面积 | 将所有可能工具暴露为高密度工具盘；把精度营销用语当作可信度证据 |
...
| F5 | 长时间抬手不是可接受的默认前提 | E-U2 gap, P2 | medium | 放点是短动作，完成后可放下手；所有手势有控制器/面板回退 |
...
| Competitive benchmark | ≥3 products and four dimensions each | §3A C1–C3 | pass |
...
- **Deliverables**：research evidence + domain model revision 4.
