...
> Source identity: `spatial-ruler-design-run-4-20260816` | Active artifact revision: **1** | Source: PM r1, user requirement, official rules, and bounded source observations independently re-evaluated in this run. Prior review verdicts are not reused.
...
- **Assumptions to be validated**：PM A1–A6，尤其是 Full Space Stage 中平面/网格可用性、张掌清除的误触风险、地面基准可用性、<2 cm 目标的环境边界。
